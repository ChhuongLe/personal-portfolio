  ...
  return (
    <div className=" hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200">
      <motion.div
        ...
        viewport={{once: true}}
        className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[300px] h-[520px] overflow-x-hidden md:w-[500px] md:h-[600px] xl:w-[600px] xl:h-auto xl:overflow-hidden snap-center bg-[#292929] p-10 overflow-scroll"
      >
        <Image src={image}
        alt=''
        width={150}
