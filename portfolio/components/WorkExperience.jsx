...
export default function WorkExperience({ experience }){
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:h-[70vh] flex space-x-5 overflow-x-scroll snap-x snap-mandatory scrollbar scrollbar-thin scrollbar-track-gray-400 scrollbar-thumb-[#DCD7C9]">
        {data.map((el) => {
          return (
            <ExperienceCard
              key={el._id}
